...
class SignUpController: UIViewController {
    ...
    private let fullnameTextField: UITextField = {
        return UITextField().textField(withPlaceholder: "Fullname", isSecureTextEntry: true)
    }()
    ...
    private lazy var accountTypeController: UIView = {
    ...
    private let SignUpButtoon: AuthButton = {
    ...
    func configureUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [emailContainerView, fullnameContainerView, passwordContainerView, accountTypeController, SignUpButtoon])
        stack.axis = .vertical
        ...
        alreadyHaveAccountButton.anchor(bottom: view.safeAreaLayoutGuide.bottomAnchor, marginBottom: 32)
    }
}
